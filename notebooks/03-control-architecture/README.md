...
2. **[IN PROGRESS]** [Linear Controller](https://github.com/ivogeorg/FCND-Controls-CPP/blob/main/notebooks/03-control-architecture/2-Linear-Controller.ipynb). (solution)  
